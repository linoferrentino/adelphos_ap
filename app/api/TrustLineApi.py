...
class TrustLineApi(BaseApi):
    ...
    async def _hndl_tl_create(self):
        ...
        # to create a trust line I need at least another alias and a referee.
        ...
        exchange = self.gateway.get_param_safe("exchange", 1)

        # the default is 1 decibel, which is 1 Credit
        strength = self.gateway.get_param_safe("strength", 1)
        ...
        # Now I can create the trust line.
        pass
