...
class EFdbErrors(IntEnum):
    ...
    EFDB_DELETED_OBJECT = 34
    EFDB_CONFLICT_DURING_UPDATE = 35
    EFDB_LOCAL_URI_UNEXPECTED_HERE = 36
    EFDB_SCHEMA_DOWNGRADE_NOT_SUPPORTED = 37
    EFDB_UNDEFINED_UPGRADE = 38
    EFDB_SCHEMA_SYNTAX_ERROR = 39
    EFDB_TRANSIENT_FIELD = 40
    EFDB_RESURECTION_NOT_ALLOWED_YET = 41
    EFDB_UPGRADE_REMOTE_OBJECT_NOT_ALLOWED = 42
